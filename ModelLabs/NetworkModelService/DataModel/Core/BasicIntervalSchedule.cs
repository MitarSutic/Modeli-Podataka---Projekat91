...
namespace FTN.Services.NetworkModelService.DataModel.Core
{
    public class BasicIntervalSchedule : IdentifiedObject
    {
        ...
        public virtual bool HasProperty(ModelCode property)
        {
            switch (property)
            {
                case ModelCode.BIS_START_TIME:
                case ModelCode.BIS_VALUE1_MULTIPLIER:
                case ModelCode.BIS_VALUE1_UNIT:
                case ModelCode.BIS_VALUE2_MULTIPLIER:
                case ModelCode.BIS_VALUE2_UNIT:
                    return true;
